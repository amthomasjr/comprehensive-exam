...
\begin{frame}
	...
	\begin{enumerate}
		...
		\item Compute the posterior
			...
			\end{itemize}
		\item Report summaries
		 	\begin{itemize}
		 		\item Posterior mean: $\E \left[ {\bm \Theta} | {\bm X} \right]$
		 		\item Posterior (co)variances: $\Var \left[ {\bm \Theta} | {\bm X} \right]$
		 	\end{itemize}
	\end{enumerate}
\end{frame}
...
\begin{frame}
	...
	Consider a model with data $\bm X$ and unknowns $\bm Z$. 
	...
	\end{equation}
	and report posterior means and covariances.
	\begin{enumerate}
		\item 
	\end{enumerate}
\end{frame}
...
\begin{frame}
	...
	\begin{enumerate}
		...
		\item The gold standard is to use MCMC
	\end{enumerate}
\end{frame}
