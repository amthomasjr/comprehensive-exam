...
\begin{frame}
	...
	\end{equation*}
	is a matrix polynomial of factor loadings in the lag operator $L$ and
	\begin{equation*}
...
\begin{frame}
	...
	Take a large panel of data and split it into a smaller number of blocks, each of which consists of a reasonably large number of series. 
	\begin{itemize}
		\item Each block is driven by its own block-specific factors
		\item The block-specific factors have a component driven by factors that are common across all of the blocks
	\end{itemize}
	\bigskip
	
	Thus, a series in a given block $b$ has three sources of variation:
	\begin{enumerate}
		\item idiosyncratic
		\item block-specific
		\item common
