...
\begin{frame}
	...
	\begin{equation}
		\begin{aligned}
			...
			&= \E_q \left[ \log \frac{p \left( {\bm X}, {\bm Z} \right)}{q \left( {\bm Z} \right)} \right]
		\end{aligned} \label{ELBO}
	\end{equation}
	It can be shown that 
	\begin{equation*}
...
\begin{frame}
	...
	\begin{enumerate}
		...
		\item Straightforward to optimize via coordinate descent
...
\subsection{Classical Factor Analysis}
